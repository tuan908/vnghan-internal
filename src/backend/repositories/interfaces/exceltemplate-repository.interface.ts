import type { ExcelTemplateModel, SelectExcelTemplate } from "@/backend/models/exceltemplate.model";
...
export interface ExcelTemplateRepository {
    ...
    findBy(filters: Record<string, any>): Promise<RecursivelyReplaceNullWithUndefined<SelectExcelTemplate> | undefined>
}